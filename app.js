...
const DEFAULT_NEWS = [
    {
        id: "news-1",
        title: "සමෘද්ධි නිවාස සංවර්ධන ලොතරැයි ජයග්‍රාහකයින් සදහා ත්‍යාග ප්‍රදානය",
        category: "project",
        date: "2026-06-10",
    ...
    {
        id: "news-2",
        title: "2026 වර්ෂය සදහා නව සමෘද්ධි ජීවනෝපාය අයදුම්පත් කැඳවීම",
        category: "announcement",
        date: "2026-06-08",
        excerpt: "ස්වයං රැකියා සහ කෘෂිකාර්මික ජීවනෝපාය සංවර්ධන ව්‍යාපෘති සඳහා සහනාධාර සහ ණය ලබාගැනීමට කැමති ප්‍රතිලාභීන්ගෙන් අයදුම්පත් කැඳවීම ඇරඹේ.",
    ...
    {
        id: "news-4",
        title: "ප්‍රාදේශීය ව්‍යවසායකයින් සදහා අලෙවි පුහුණු වැඩසටහන",
        category: "notice",
        date: "2026-06-02",
        excerpt: "අලෙවි ඒකකය මගින් මෙහෙයවනු ලබන ව්‍යවසායකත්ව සංවර්ධන සහ ඇසුරුම්කරණ පුහුණු වැඩමුළුව ලබන බදාදා දින පැවැත්වේ.",
        content: "කඹුරුපිටිය සමෘද්ධි අලෙවි ඒකකය මගින් සංවිධානය කරනු ලබන එක්දින ව්‍යවසායකත්ව සංවර්ධන පුහුණු කඳවුර 2026 ජූනි 17 දින පෙරවරු 9.00 සිට ප්‍රාදේශීය ලේකම් කාර්යාලයීය ශ්‍රවණාගාරයේදී පැවැත්වේ. මෙහිදී නිෂ්පාදන ප්‍රමිතිකරණය, ආකර්ශනීය ඇසුරුම්කරණය සහ ඩිජිටල් අලෙවිකරණය පිළිබඳව ක්ෂේත්‍රයේ ප්‍රවීණයන් විසින් නොමිලේ පුහුණුව ලබාදීමට නියමිතය. ලියාපදිංචි වීමට ඔබගේ ප්‍රදේශයේ බැංකු මහාසංගමය අමතන්න."
    }
];
...
const DEFAULT_STAFF = [
    {
        id: "staff-1",
        name: "එච්. පී. ජී. ධර්මවර්ධන මහතා",
        designation: "ප්‍රධාන සමෘද්ධි කළමනාකරු",
        phone: "0412292570",
        email: "manager.samurdhi@kds.gov.lk",
        photo: "assets/staff/staff_1.jpg"
    },
    {
        id: "staff-2",
        name: "කේ. එල්. ප්‍රියන්ති මහත්මිය",
        designation: "සමෘද්ධි මහාසංගම ලේකම්",
        phone: "+94 71 859 4236",
        email: "federation.sec@kds.gov.lk",
        photo: "assets/staff/staff_2.png"
    },
    {
        id: "staff-3",
        name: "ජී. ඩබ්ලිව්. නිහාල් මහතා",
        designation: "ප්‍රජාමූල බැංකු කළමනාකරු",
        phone: "+94 77 345 6781",
        email: "bank.mgr@kds.gov.lk",
        photo: "assets/staff/staff_3.jpg"
    },
    {
        id: "staff-4",
        name: "කේ. ජී. සමන් කුමාර මහතා",
        designation: "සමාජ සංවර්ධන නිලධාරී",
